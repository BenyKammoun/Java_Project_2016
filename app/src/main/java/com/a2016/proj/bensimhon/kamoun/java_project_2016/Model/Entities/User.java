...
public class User {
    ...
    * */
    private int ID;
    private String name;
    private ContactsContract.CommonDataKinds.Email userName;
    ...
    * */
    ...
    public ContactsContract.CommonDataKinds.Email getUserName() {
        return userName;
    }
    public void setUserName(ContactsContract.CommonDataKinds.Email userName) {
